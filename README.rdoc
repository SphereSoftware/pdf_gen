...
=== Smart Table
Object which allows creating tables from Hash and ActiveRecord objects. Blocks of the title and footer you have to define
independently if necessary. For example:
