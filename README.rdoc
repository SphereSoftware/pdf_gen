...
=== Smart Table
Object which allows creating tables from Hash and ActiveRecord object. Blocks of the title and footer you have to define
independently if necessary. For examples:
...
Build table from ActiveRecord (ROR)
...
We Can setting width of each column
