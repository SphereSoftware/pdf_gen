  ...
  div :width => 21.55.cm, :horizontal_interval => 1.0.cm,
    ...
    span :width => 20.cm, :pad_left => 0.05.cm, :border => true, :border_width => 0.05.cm, :border_color => Color::RGB::Red, :background_color => Color::RGB::LightPink do
     ...
     caption ' * mathematical background (solution algorithms), ', :width => 10.5.cm, :justification => :left,
        ...
        :pad_left => 0.5.cm, :pad_right => 0.3.cm, :pad_top => 0.7.cm,
        :text_color => Color::RGB::Grey, :font_size => 12
     caption ' * efficient problem solving & good modeling practice, ', :width => 11.0.cm, :justification => :left, :border => false, :border_style => :solid, :border_width => 0.2.cm, :border_color => Color::RGB::Grey,
        :pad_left => 0.5.cm, :pad_right => 0.3.cm, :pad_top => 0.7.cm,
        :text_color => Color::RGB::Grey, :font_size => 12
     caption ' * mathematical modeling & optimization in practice, ', :width => 10.5.cm, :justification => :left, :border => false, :border_style => :solid, :border_width => 0.2.cm, :border_color => Color::RGB::Grey,
        :pad_left => 0.5.cm, :pad_right => 0.3.cm, :pad_top => 0.7.cm,
        :text_color => Color::RGB::Grey, :font_size => 12
     caption ' * practioners\'s requirements towards modeling languages ', :width => 10.5.cm, :justification => :left, :border => false, :border_style => :solid, :border_width => 0.2.cm, :border_color => Color::RGB::Grey,
        :pad_left => 0.5.cm, :pad_right => 0.3.cm, :pad_top => 0.7.cm,
        :text_color => Color::RGB::Grey, :font_size => 12
